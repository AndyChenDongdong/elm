...
class ShopListItemCell: UITableViewCell {
    ...
    //点击+ - 按钮
    typealias ShopListItemAddOrMinusButtonClicked = (UIButton,_ addSate: Bool) -> ()
    ...
    override func awakeFromNib() {
        ...
        addButtonView.addBtnClicked = {
            ...
            self.itemAddOrMinusButtonClicked?(sender, add)
        }
    }

    func setShoplistItem(_ item: ShoplistItem) {
